...
Version 1 is in progress. Milestones 0 through 2 are complete: the warehouse holds a NJ
geography spine (3,365 regions, 1,902 allocation weights) and 309,350 Zillow home-value
and rent observations spanning 2000–2026, all served over the API, with 81 tests
passing. Milestone 3 is next.
