...
make test          # 461 Python + 79 dashboard tests; API tests skip without a warehouse
...
```bash
make publish   # dist/artifacts (5,910 files, 108 MB) + dist/site (13,649 files, 489 MB)
